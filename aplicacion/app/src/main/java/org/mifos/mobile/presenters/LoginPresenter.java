...
public class LoginPresenter extends BasePresenter<LoginView> {
     ...
     *
     * @param username Username of the user trying to login.
     * @param isFacialAuthenticated boolean if face matches the user trying to login.
     */
    public void loginWithFacialRecognition(final String username, final Boolean isFacialAuthenticated) {
        checkViewAttached();
        if (isCredentialsValid(username, "password")) {
            getMvpView().showProgress();
            compositeDisposable.add(dataManager.login(username, "password")
